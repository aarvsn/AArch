...
static const emu_core_info_t registry[] = {
    ...
    { "finalburn", EMU_STATUS_PARTIAL,
      ...
      ref_finalburn },
    { "beatle-psx", EMU_STATUS_SKELETON,
      "PlayStation: ROM detection only; CPU/GPU/SPU not implemented",
      ref_psx },
    { "mds-a", EMU_STATUS_SKELETON,
      "Nintendo DS: ROM detection only; dual ARM not implemented",
      ref_ds },
    { "ms-32", EMU_STATUS_SKELETON,
      "Sega 32X: ROM detection only; SH-2 x2 not implemented",
      ref_32x },
